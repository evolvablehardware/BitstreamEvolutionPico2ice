...
class ConfigSetting:
    ...
    def mutate(self):
        self.current = random.choice(list(self.options) + [None])
...
# import time
# all_tiles = [(x, y) for x in range(1, 25) for y in range(1, 31) if (x, y) in icebox.logic_tiles]
